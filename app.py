...
CLIENT = InferenceHTTPClient(
    ...
    api_key="yZBoRH7sJuUfoB17IdeQ"
)

# Initialize Roboflow Client for video
rf = Roboflow(api_key="yZBoRH7sJuUfoB17IdeQ")
project = rf.workspace().project("school-uniform-ei3lg")
...
def detect_image():
    ...
    result = CLIENT.infer(image_path, model_id="school-uniform-ei3lg/1")
    ...
    if detected_school_uniform and detected_tie:
        ...
        return jsonify({"status": "non_uniform_and_tie_detected"})
